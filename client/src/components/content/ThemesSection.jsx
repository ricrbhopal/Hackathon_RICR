...
const getThemeIcon = (themeName) => {
  const iconMap = {
    ...
    "AI in Education": <LuBrainCircuit />,
    ...
    "Smart Education & Learning Platforms": <MdCastForEducation />,
  };
  ...
  for (const [key, icon] of Object.entries(iconMap)) {
    if (
      themeName.toLowerCase().includes(key.toLowerCase()) ||
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-5">
                  <motion.div
                    className="text-3xl md:text-4xl text-[#0B2A4A]"
                ...
                <p className="text-gray-600 leading-relaxed cursor-default line-clamp-2">
                  {theme.themeShortDescription ||
                    theme.themeDescription?.substring(0, 150) + "..." ||
                ...
                <div className="flex justify-between items-center mt-4">
                  <div className="flex items-center gap-2 ">
                    {theme.teamCount !== undefined &&
                      ...
                      (enrolled > 0 ? (
                        <span
                          className={`inline-block text-sm mt-3 text-white py-2 px-5 rounded-lg ${
                            remaining === 0 ? "bg-red-500" : "bg-[#0B2A4A]"
                          }`}
                        >
                        ...
                        <span
                          className={`inline-block text-sm mt-3 text-white py-2 px-5 rounded-lg bg-[#0B2A4A]`}
                        >
                          {`${MAX_TEAMS} left`}
                        </span>
                      ))}
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[80vh] p-6 overflow-hidden">
            ...
            <div className="mb-6">
              ...
              <div className="max-h-96 overflow-y-auto">
                {selectedTeams.enrolledTeams &&
                selectedTeams.enrolledTeams.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      {Math.max(0, MAX_TEAMS - (selectedTeams.teamCount ?? 0)) >
                      0
                        ? `${Math.max(
                            0,
                            MAX_TEAMS - (selectedTeams.teamCount ?? 0)
                          )} slots left`
                        : "Full"}
                    </p>
                  </div>
