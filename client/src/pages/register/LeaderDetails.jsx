...
const LeaderDetails = () => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      toast.success(
        "OTPs sent successfully to your email and phone! Please proceed to verification."
      );
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleInputChange("leaderEmail", e.target.value)
                }
                className={`w-full px-3 md:px-4 py-2 md:py-3 border rounded-lg focus:ring-2 focus:ring-[#1D5B9B] focus:border-transparent text-sm md:text-base ${
            ...
            <div>
              <div className="flex">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("leaderPhone", e.target.value)
                  }
